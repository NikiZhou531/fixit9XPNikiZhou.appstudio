...
const cacheName = 'fixit9XPNikiZhou-2020-10-25 21:18:38.885197'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'toolbox/jqw/dist/jqxFunctions.js',
  'toolbox/bs4/dist/bsFunctions.min.js',
  'toolbox/bs4/dist/css/bootstrap.min.css',
  'toolbox/bs4/dist/css/dataTables.bootstrap4.min.css',
  'toolbox/bs4/dist/js/dataTables.bootstrap4.min.js',
  'toolbox/bs4/dist/js/bootstrap.bundle.min.js',
  'toolbox/bs4/dist/js/jquery.dataTables.min.js',
  'toolbox/bs4/dist/open-iconic/css/open-iconic-bootstrap.min.css',
  'toolbox/bs4/dist/open-iconic/fonts/open-iconic.woff',
  'toolbox/bs4/dist/fonts/glyphicons-halflings-regular.woff',
  'toolbox/bs4/dist/fonts/glyphicons-halflings-regular.woff2',
  'toolbox/bs4/dist/fonts/glyphicons-halflings-regular.ttf',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit9XPNikiZhou'.length) === 'fixit9XPNikiZhou') {
