...
// an array of arrays. One array for each row.
 var data1 = [
    ["Ian Ogea", "Student", "Omaha", "5421", "2017/08/20", "$0"],
    ["LeBron James", "Basketball Player", "Los Angeles", "8422", "2011/07/25", "$37,000,000"],
...
dataTable.onshow=function(){
  alrtChanges.value = "Added Ian Ogea and Lebron James to the datatable"
}
